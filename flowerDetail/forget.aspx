            ...
            <div class="middle">
                ...
                <div style="position:absolute;right:150px;top:80px;background-color:white;width:360px;height:450px;border-radius:20px;">
                    <div style="height:60px;">
                        <div style="float:left;width:280px;margin-top:10px;"><strong style="text-align:center;font-size:20px;font-family:微软雅黑;line-height:60px;margin-left:130px; color:coral;padding:2px;">找回密码</strong></div>
                        <div style="float:left;width:30px;margin-top:27px;">
                            <img src="imgForDLZC/icon.png" style="width:26px;height:26px;"/>
                        </div>
                    </div>
                    <div style="height:385px;">
                        <div style="text-align:center;margin-top:20px;height:40px;">
                            <asp:TextBox ID="txtusername" runat="server" placeholder="请输入您的昵称" Height="40px" Width="70%" style="border:1px solid lightgray;background:url('imgForDLZC/user1.png') no-repeat;background-size:20px 20px;background-position:5px 9px; border-radius:5px;padding-left:30px;" >&nbsp;</asp:TextBox>
                        </div>
                        <div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="用户名不能为空" ControlToValidate="txtusername" style="height:10px;margin-left:40px;font-size:12px;color:coral;"></asp:RequiredFieldValidator>
                        </div>
                        <div style="text-align:center;height:40px;margin-top:15px">
                            <asp:TextBox ID="txtemail" placeholder="请输入您的绑定的邮箱" Height="40px" Width="70%" runat="server" style="border:1px solid lightgray;background:url('imgForDLZC/email1.png') no-repeat;background-size:20px 20px;background-position:5px 10px; border-radius:5px;padding-left:32px;">&nbsp;</asp:TextBox>
                        </div>
                        <div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="邮箱不能为空" ControlToValidate="txtemail" style="height:10px;margin-left:40px;font-size:12px;color:coral;" ></asp:RequiredFieldValidator>
                        </div>
                        <div style="text-align:center;height:40px;margin-top:15px">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="密码不能为空" ControlToValidate="txtpassword" style="height:10px;margin-left:40px;font-size:12px;color:coral;" ></asp:RequiredFieldValidator>
                        </div>
                        <div style="text-align:center;height:40px;margin-top:15px">
                        ...
                        <div>
                             <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="两次密码不一致" ControlToCompare="txtpassword" ControlToValidate="txtrepassword"  style="height:10px;margin-left:40px;font-size:12px;color:coral;"></asp:CompareValidator>
                        </div>
                        <div style="margin-left:37px; height:40px;margin-top:15px;">
                            <asp:TextBox ID="yzm" placeholder="请输入验证码" Height="40px" Width="50%" runat="server" style="border:1px solid lightgray;background:url('imgForDLZC/check1.png') no-repeat;background-size:21px 20px;background-position:5px 10px; border-radius:5px;padding-left:33px;"></asp:TextBox>
                            <img src="yzm.aspx"/>
                        </div>
                        <div style="text-align:center;margin-top:25px;">
                            <asp:Button ID="Button1" CssClass="registerbtn" runat="server" Text="确认并登录" style="height: 40px; width:80%;border-radius:15px" OnClick="Button1_Click"/>
                        </div>
                        <div style="margin-left:42px;margin-top:10px;">
                            <a onclick="back()" style="color:coral;text-decoration:none;font-size:12px;cursor: pointer">
                                &laquo;返回上一页
                            </a>
                        </div>
                    </div>
