<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="birthday2.aspx.cs" Inherits="birthday.birthday2" %>
	...
	<script src="js/dianjidonghua.js"></script>
		...
		<style>
			*{margin: 0;padding: 0;}
			...
			input{width: 130px;height: 36px; border: 1px solid #CFE1E6;font-size: 16px; background: #CFE1E6;color: #487687;}
			...
			ul{margin: 2px;padding: 2px;position:relative;left:-2px}
    ...
    <form id="form1" runat="server">
		<div class="web">
			...
			<div style="height: 7750px;">
				<div><img src="img/birthday_lunbo2.png" id="img1" /></div>
				<div>
				...
				<!--鲜花-->
				<div>
					<div style="height: 195px;"><img src="img/background5.png" id="img1"/></div>
					<div style="height: 750px;">
						<div style="width: 620px;height: 685px;position: relative;float: left;">
							<div style="background: #CFE1E6;width: 580px;height: 595px;"></div>
						...
						<div style="width: 580px;height: 685px;float: left;">
							...
							<div style="height: 280px;position: relative;">
								<img src="img/background2_1.png" style="height: 280px;"/>
				...
				<!--蛋糕 -->
				<div>
					<div style="height: 195px;"><img src="img/background6.png" id="img1"/></div>
					<div style="height: 690px;">
						...
						<div style="width: 595px;height: 690px;float: left;margin-left: 15px;">
							<div style="height: 340px;">
								...
								<div style="width: 298px;height: 285px;margin-left: 10px;background: url(img/download2.png); float: left;">
							...
							<div style="height: 340px;">
								<div style="width: 298px;height: 285px;background: url(img/download2.png) 0 0 no-repeat; transform: rotate(180deg); float: left;">
					...
					<div style="height: 395px;">
						<div style="width: 600px;margin-top: 60px;float: left;"><img src="img/background2_2.png" style="position: relative;z-index: -1;right: 300px;"/></div>
						<div style="float: left;">
				...
				<!--永生花-->
				<div>
					<div style="height: 195px;"><img src="img/background7.png" id="img1"/></div>
					<div style="height: 910px;">
						<div style="width: 579px;height: 840px;float: left;">
							<div style="height: 385px;margin-top: 40px;">
								<div style="float: left;">
				...
				<!--礼品-->
				<div>
					<div style="height: 195px;"><img src="img/background8.png" id="img1"/></div>
					<div style="height: 385px;">
						<div style="width: 285px;height: 385px;float: left;">
					...
					<div style="height: 395px;">
						<div style="width: 600px;margin-top: 60px;float: left;"><img src="img/background2_1.png" style="position: relative;z-index: -1;right: 300px;"/></div>
						<div style="float: left;">
							<div style="width: 285px;height: 360px;float: left;">
