<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kaiyeshangwu.aspx.cs" Inherits="flowerDetail.kaiyeshangwu" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
			*{margin: 0;padding: 0;}
			...
			ul li{list-style-type: none;text-align: center;border: 1px solid #CCC;line-height:24px;background: #eee;opacity:0.9;height: 45px;line-height: 45px;}
    ...
    <form id="form1" runat="server">
        <div style="width:100%;">
			...
			<div class="header">
				...
				<div id="topimg">
					<img src="img/flower_bannerFopen_171019.jpg" alt="Alternate Text"/>
				</div>
